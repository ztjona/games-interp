...
targets, fresh `gold` position sets): the 2026-09-14 pre-registration.
...
pwsh -File runners\launch.ps1 3B-causal -Set gold3,gold5 -DryRun   # Wave 1b: builds missing sets, + freshness, feasibility
pwsh -File runners\launch.ps1 3B-causal -Set gold3,gold5           # Wave 1b: both sets in parallel, one GPU each
